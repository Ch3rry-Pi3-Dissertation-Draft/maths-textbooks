...
```
```{=latex}
\fancyhead[L]{\sffamily\small\color{ChapterBlue}\textbf{Chapter 8}}
\fancyhead[R]{\sffamily\small\color{BodyInk}Theory Of Linear ODE Solutions}
```
...
```
## Recognising A Linear Equation Of Any Order {#block-1-recognising-a-linear-equation-of-any-order}
...
\Needspace{12\baselineskip}
```
### The General Linear Pattern {#the-general-linear-pattern-2}
...
\Needspace{12\baselineskip}
```
### Order And Linearity Are Separate {#order-and-linearity-are-separate-3}
...
\Needspace{12\baselineskip}
```
### Homogeneous And Nonhomogeneous {#homogeneous-and-nonhomogeneous-4}
...
\Needspace{12\baselineskip}
```
### Constant And Variable Coefficients {#constant-and-variable-coefficients-5}
...
\Needspace{12\baselineskip}
```
### Normal Form And The Working Interval {#normal-form-and-the-working-interval-6}
...
\Needspace{12\baselineskip}
```
### A Classification Workflow {#a-classification-workflow-7}
...
\Needspace{20\baselineskip}
```
## The Linear Differential Operator {#block-2-the-linear-differential-operator}
...
\Needspace{12\baselineskip}
```
### Defining The Operator {#defining-the-operator-10}
...
\Needspace{12\baselineskip}
```
### What Operator Linearity Means {#what-operator-linearity-means-11}
...
\Needspace{12\baselineskip}
```
### Worked Operator Check {#worked-operator-check-12}
...
\Needspace{12\baselineskip}
```
### Why A Nonlinear Operator Fails {#why-a-nonlinear-operator-fails-13}
...
\Needspace{20\baselineskip}
```
## Existence, Uniqueness, And Initial Data {#block-3-existence-uniqueness-and-initial-data}
...
\Needspace{12\baselineskip}
```
### The Initial Data For An $n$th-Order Equation {#the-initial-data-for-an-nth-order-equation-16}
...
\Needspace{12\baselineskip}
```
### The Existence-And-Uniqueness Statement {#the-existence-and-uniqueness-statement-17}
...
\Needspace{12\baselineskip}
```
### Worked Interval Example {#worked-interval-example-18}
...
\Needspace{12\baselineskip}
```
### What Happens If The Initial Point Is Singular? {#what-happens-if-the-initial-point-is-singular-19}
...
\Needspace{12\baselineskip}
```
### Uniqueness And The Zero Solution {#uniqueness-and-the-zero-solution-20}
...
\Needspace{20\baselineskip}
```
## Superposition And The Homogeneous Solution Space {#block-4-superposition-and-the-homogeneous-solution-space}
...
\Needspace{12\baselineskip}
```
### The Superposition Principle {#the-superposition-principle-23}
...
\Needspace{12\baselineskip}
```
### Why The Right Side Must Be Zero {#why-the-right-side-must-be-zero-24}
...
\Needspace{12\baselineskip}
```
### Running Example: Two Oscillatory Solutions {#running-example-two-oscillatory-solutions-25}
...
\Needspace{12\baselineskip}
```
### The Solution Set Behaves Like A Vector Space {#the-solution-set-behaves-like-a-vector-space-26}
...
\Needspace{12\baselineskip}
```
### Why The Order Predicts The Number Of Directions {#why-the-order-predicts-the-number-of-directions-27}
...
\Needspace{12\baselineskip}
```
### A Third-Order Illustration {#a-third-order-illustration-28}
...
\Needspace{20\baselineskip}
```
## Linear Independence Without A Determinant {#block-5-linear-independence-without-a-determinant}
...
\Needspace{12\baselineskip}
```
### The Definition {#the-definition-31}
...
\Needspace{12\baselineskip}
```
### A Dependent Set With An Explicit Relation {#a-dependent-set-with-an-explicit-relation-32}
...
\Needspace{12\baselineskip}
```
### An Independent Polynomial Set {#an-independent-polynomial-set-33}
...
\Needspace{12\baselineskip}
```
### A Direct Test For Two Functions {#a-direct-test-for-two-functions-34}
...
\Needspace{12\baselineskip}
```
### Independence Depends On The Interval {#independence-depends-on-the-interval-35}
...
\Needspace{12\baselineskip}
```
### Why The Number Of Functions Is Not Enough {#why-the-number-of-functions-is-not-enough-36}
...
\Needspace{20\baselineskip}
```
## The Wronskian As An Independence Test {#block-6-the-wronskian-as-an-independence-test}
...
\Needspace{12\baselineskip}
```
### The Two-Function Wronskian {#the-two-function-wronskian-39}
...
\Needspace{12\baselineskip}
```
### Worked Two-Function Calculation {#worked-two-function-calculation-40}
...
\Needspace{20\baselineskip}
```
## Fundamental Sets And Initial Conditions {#block-7-fundamental-sets-and-initial-conditions}
...
\Needspace{20\baselineskip}
```
## The Structure Of Nonhomogeneous Solutions {#block-8-the-structure-of-nonhomogeneous-solutions}
...
\Needspace{20\baselineskip}
```
## A Reliable Theory Workflow And Common Mistakes {#block-9-a-reliable-theory-workflow-and-common-mistakes}
