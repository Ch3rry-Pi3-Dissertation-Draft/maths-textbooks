...
```
```{=latex}
\fancyhead[L]{\sffamily\small\color{ChapterBlue}\textbf{Chapter 20}}
\fancyhead[R]{\sffamily\small\color{BodyInk}Second-Order Numerical Methods}
```
...
```
## Turning Order Into State {#block-1-turning-order-into-state}
...
\Needspace{12\baselineskip}
```
### Why A Numerical Method Wants First-Order Form {#why-a-numerical-method-wants-first-order-form-2}
...
\Needspace{12\baselineskip}
```
### The Reduction Pipeline {#the-reduction-pipeline-3}
...
\Needspace{12\baselineskip}
```
### How The Initial Conditions Move {#how-the-initial-conditions-move-4}
...
\Needspace{12\baselineskip}
```
### A Complete Reduction Example {#a-complete-reduction-example-5}
...
\Needspace{12\baselineskip}
```
### Why The Highest-Derivative Coefficient Matters {#why-the-highest-derivative-coefficient-matters-6}
...
\Needspace{12\baselineskip}
```
### A Third-Order Preview {#a-third-order-preview-7}
...
\Needspace{12\baselineskip}
```
### Common Reduction Mistakes {#common-reduction-mistakes-8}
...
\Needspace{20\baselineskip}
```
## A Shared Benchmark Problem {#block-2-a-shared-benchmark-problem}
...
\Needspace{12\baselineskip}
```
### The Second-Order Problem {#the-second-order-problem-11}
...
\Needspace{12\baselineskip}
```
### Name The Two Right-Hand Sides {#name-the-two-right-hand-sides-12}
...
\Needspace{12\baselineskip}
```
### An Exact Benchmark For Checking {#an-exact-benchmark-for-checking-13}
...
\Needspace{12\baselineskip}
```
### What One Numerical Row Must Store {#what-one-numerical-row-must-store-14}
...
\Needspace{20\baselineskip}
```
## Euler's Method For A Pair Of States {#block-3-eulers-method-for-a-pair-of-states}
...
\Needspace{12\baselineskip}
```
### The Paired Euler Formula {#the-paired-euler-formula-17}
...
\Needspace{12\baselineskip}
```
### Why The Two Updates Are Simultaneous {#why-the-two-updates-are-simultaneous-18}
...
\Needspace{12\baselineskip}
```
### Euler Step 0 To Step 1 {#euler-step-0-to-step-1-19}
...
\Needspace{12\baselineskip}
```
### Euler Step 1 To Step 2 {#euler-step-1-to-step-2-20}
...
\Needspace{12\baselineskip}
```
### Compare With The Exact State {#compare-with-the-exact-state-21}
...
\Needspace{12\baselineskip}
```
### Common Mistake: Feeding A New Value Into The Old Step {#common-mistake-feeding-a-new-value-into-the-old-step-22}
...
\Needspace{20\baselineskip}
```
## Classical RK4 For A Coupled Pair {#block-4-classical-rk4-for-a-coupled-pair}
...
\Needspace{12\baselineskip}
```
### Two Increments At Every Stage {#two-increments-at-every-stage-25}
...
\Needspace{12\baselineskip}
```
### The Paired RK4 Update {#the-paired-rk4-update-26}
...
\Needspace{12\baselineskip}
```
### RK4 Stage 1 For The Benchmark {#rk4-stage-1-for-the-benchmark-27}
...
\Needspace{12\baselineskip}
```
### Combine The Four Stage Pairs {#combine-the-four-stage-pairs-31}
...
\Needspace{12\baselineskip}
```
### Check Both Components {#check-both-components-32}
...
\Needspace{12\baselineskip}
```
### Euler And RK4 Across The Interval {#euler-and-rk4-across-the-interval-33}
...
\Needspace{12\baselineskip}
```
### Common RK4 Pairing Mistakes {#common-rk4-pairing-mistakes-34}
...
\Needspace{12\baselineskip}
```
### Block 4 Summary {#block-4-summary-35}
...
\Needspace{20\baselineskip}
```
## ABM4 For Two Coupled Equations {#block-5-abm4-for-two-coupled-equations}
...
\Needspace{12\baselineskip}
```
### Two Histories Must Be Stored {#two-histories-must-be-stored-37}
...
\Needspace{12\baselineskip}
```
### The Paired AB4 Predictors {#the-paired-ab4-predictors-38}
...
\Needspace{12\baselineskip}
```
### The Predicted Endpoint Derivatives {#the-predicted-endpoint-derivatives-39}
...
\Needspace{12\baselineskip}
```
### The Paired AM4 Correctors {#the-paired-am4-correctors-40}
...
\Needspace{12\baselineskip}
```
### The RK4 Start-Up Table {#the-rk4-start-up-table-41}
...
\Needspace{12\baselineskip}
```
### ABM Step 1: Predict Both State Components {#abm-step-1-predict-both-state-components-42}
...
\Needspace{12\baselineskip}
```
### ABM Step 2: Evaluate The Predicted Derivatives {#abm-step-2-evaluate-the-predicted-derivatives-43}
...
\Needspace{12\baselineskip}
```
### ABM Step 3: Correct Both Components {#abm-step-3-correct-both-components-44}
...
\Needspace{12\baselineskip}
```
### Compare Prediction, Correction, And Exact State {#compare-prediction-correction-and-exact-state-45}
...
\Needspace{12\baselineskip}
```
### Block 5 Summary {#block-5-summary-46}
...
\Needspace{20\baselineskip}
```
## Milne's Method For The System {#block-6-milnes-method-for-the-system}
...
\Needspace{12\baselineskip}
```
### The Paired Milne Predictors {#the-paired-milne-predictors-48}
...
\Needspace{12\baselineskip}
```
### The Paired Milne Correctors {#the-paired-milne-correctors-49}
...
\Needspace{12\baselineskip}
```
### A Complete Milne Prediction {#a-complete-milne-prediction-50}
...
\Needspace{12\baselineskip}
```
### Calculate The Predicted Slopes And Correct {#calculate-the-predicted-slopes-and-correct-51}
...
\Needspace{12\baselineskip}
```
### Completed Milne State {#completed-milne-state-52}
...
\Needspace{12\baselineskip}
```
### A Two-Component Gap Diagnostic {#a-two-component-gap-diagnostic-53}
...
\Needspace{12\baselineskip}
```
### Block 6 Summary {#block-6-summary-54}
...
\Needspace{20\baselineskip}
```
## Generalisation, Diagnostics, And Workflow {#block-7-generalisation-diagnostics-and-workflow}
...
\Needspace{12\baselineskip}
```
### The Vector View {#the-vector-view-56}
...
\Needspace{12\baselineskip}
```
### Higher-Order Scalar Equations {#higher-order-scalar-equations-57}
...
\Needspace{12\baselineskip}
```
### Accuracy And Stability Are System Properties {#accuracy-and-stability-are-system-properties-58}
...
\Needspace{12\baselineskip}
```
### Common System-Level Mistakes {#common-system-level-mistakes-59}
...
\Needspace{12\baselineskip}
```
### A Reliable Calculation Workflow {#a-reliable-calculation-workflow-60}
...
\Needspace{12\baselineskip}
```
### Problems 1 To 4: Reduction And Euler {#problems-1-to-4-reduction-and-euler-63}
...
\Needspace{12\baselineskip}
```
### Problems 5 To 8: Updates And RK4 {#problems-5-to-8-updates-and-rk4-64}
...
\Needspace{12\baselineskip}
```
### Problems 9 To 12: Multistep Methods And Diagnostics {#problems-9-to-12-multistep-methods-and-diagnostics-65}
...
\Needspace{12\baselineskip}
```
### Chapter 20 Final Summary {#chapter-20-final-summary-69}
