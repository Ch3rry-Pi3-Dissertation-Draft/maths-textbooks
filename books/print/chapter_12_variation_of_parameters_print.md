...
```
```{=latex}
\fancyhead[L]{\sffamily\small\color{ChapterBlue}\textbf{Chapter 12}}
\fancyhead[R]{\sffamily\small\color{BodyInk}Variation Of Parameters}
```
...
```
## Turning Homogeneous Constants Into Functions {#block-1-turning-homogeneous-constants-into-functions}
...
\Needspace{12\baselineskip}
```
### What Problem Are We Solving? {#what-problem-are-we-solving-2}
...
\Needspace{12\baselineskip}
```
### Why Chapter 11 Needs A Companion Method {#why-chapter-11-needs-a-companion-method-3}
...
\Needspace{12\baselineskip}
```
### Why Vary The Parameters? {#why-vary-the-parameters-4}
...
\Needspace{12\baselineskip}
```
### Why One Particular Solution Is Still Enough {#why-one-particular-solution-is-still-enough-5}
...
\Needspace{20\baselineskip}
```
## Deriving The Second-Order Method {#block-2-deriving-the-second-order-method}
...
\Needspace{12\baselineskip}
```
### Start With Standard Form {#start-with-standard-form-8}
...
\Needspace{12\baselineskip}
```
### Differentiate The Proposal Without Skipping Terms {#differentiate-the-proposal-without-skipping-terms-9}
...
\Needspace{12\baselineskip}
```
### Why We Introduce The Auxiliary Condition {#why-we-introduce-the-auxiliary-condition-10}
...
\Needspace{12\baselineskip}
```
### Differentiate Again And Substitute {#differentiate-again-and-substitute-11}
...
\Needspace{12\baselineskip}
```
### The Two-Equation System {#the-two-equation-system-12}
...
\Needspace{12\baselineskip}
```
### Solve The System With The Wronskian {#solve-the-system-with-the-wronskian-13}
...
\Needspace{12\baselineskip}
```
### Integrate And Reconstruct The Particular Solution {#integrate-and-reconstruct-the-particular-solution-14}
...
\Needspace{20\baselineskip}
```
## Standard Form, Intervals, And The Wronskian {#block-3-standard-form-intervals-and-the-wronskian}
...
\Needspace{12\baselineskip}
```
### Normalize Every Term {#normalize-every-term-17}
...
\Needspace{12\baselineskip}
```
### The Equivalent Nonstandard Formula {#the-equivalent-nonstandard-formula-18}
...
\Needspace{12\baselineskip}
```
### Compute The Wronskian In A Fixed Order {#compute-the-wronskian-in-a-fixed-order-19}
...
\Needspace{12\baselineskip}
```
### The Interval Matters {#the-interval-matters-20}
...
\Needspace{12\baselineskip}
```
### A Preparation Example {#a-preparation-example-21}
...
\Needspace{20\baselineskip}
```
## Complete Second-Order Examples {#block-4-complete-second-order-examples}
...
\Needspace{12\baselineskip}
```
### A Trigonometric Forcing Outside The Trial Ledger {#a-trigonometric-forcing-outside-the-trial-ledger-24}
...
\Needspace{12\baselineskip}
```
### A Variable-Coefficient Equation {#a-variable-coefficient-equation-25}
...
\Needspace{20\baselineskip}
```
## Definite Integrals And Initial Conditions {#block-5-definite-integrals-and-initial-conditions}
...
\Needspace{12\baselineskip}
```
### Anchoring The Parameters At A Base Point {#anchoring-the-parameters-at-a-base-point-28}
...
\Needspace{12\baselineskip}
```
### A Forced Initial-Value Problem {#a-forced-initial-value-problem-29}
...
\Needspace{12\baselineskip}
```
### Why The Base Point Must Belong To The Interval {#why-the-base-point-must-belong-to-the-interval-30}
...
\Needspace{20\baselineskip}
```
## First-Order And Higher-Order Versions {#block-6-first-order-and-higher-order-versions}
...
\Needspace{12\baselineskip}
```
### First Order: Variation Of A Single Constant {#first-order-variation-of-a-single-constant-33}
...
\Needspace{12\baselineskip}
```
### A First-Order Worked Example {#a-first-order-worked-example-34}
...
\Needspace{12\baselineskip}
```
### The Higher-Order System {#the-higher-order-system-35}
...
\Needspace{12\baselineskip}
```
### A Third-Order Worked Example {#a-third-order-worked-example-36}
...
\Needspace{20\baselineskip}
```
## Workflow, Method Choice, And Common Mistakes {#block-7-workflow-method-choice-and-common-mistakes}

```{=latex}
\Needspace{12\baselineskip}
```
### The Complete Second-Order Workflow {#the-complete-second-order-workflow-38}
...
\Needspace{12\baselineskip}
```
### Choosing Between The Two Particular-Solution Methods {#choosing-between-the-two-particular-solution-methods-39}
...
\Needspace{12\baselineskip}
```
### When The Integrals Do Not Simplify {#when-the-integrals-do-not-simplify-40}
...
\Needspace{12\baselineskip}
```
### Common Mistake: Using The Unnormalized Forcing {#common-mistake-using-the-unnormalized-forcing-41}
...
\Needspace{12\baselineskip}
```
### Common Mistake: Treating The Auxiliary Condition As A Given Law {#common-mistake-treating-the-auxiliary-condition-as-a-given-law-42}
...
\Needspace{12\baselineskip}
```
### Common Mistake: Losing The Wronskian Sign {#common-mistake-losing-the-wronskian-sign-43}
...
\Needspace{12\baselineskip}
```
### Common Mistake: Adding Integration Constants Twice {#common-mistake-adding-integration-constants-twice-44}
...
\Needspace{12\baselineskip}
```
### Common Mistake: Forgetting To Return To $y_p$ {#common-mistake-forgetting-to-return-to-yp-45}
...
\Needspace{12\baselineskip}
```
### Common Mistake: Applying Conditions To The Wrong Function {#common-mistake-applying-conditions-to-the-wrong-function-46}
...
\Needspace{12\baselineskip}
```
### Worked Answers: Problems 7 To 9 {#worked-answers-problems-7-to-9-50}
...
\Needspace{12\baselineskip}
```
### Worked Answers: Problems 10 To 12 {#worked-answers-problems-10-to-12-51}
...
\Needspace{12\baselineskip}
```
### Chapter 12 Final Summary {#chapter-12-final-summary-52}
